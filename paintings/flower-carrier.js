...
paintings.push({
  ...
  draw: function (pg) {
    ...
    pg.bezierVertex(hx - w * 0.08, hy - h * 0.1, hx - w * 0.12, hy - h * 0.15, hx - w * 0.1, hy - h * 0.2);
    pg.vertex(hx - w * 0.08, hy - h * 0.2);
    pg.bezierVertex(hx - w * 0.1, hy - h * 0.14, hx - w * 0.06, hy - h * 0.08, hx - w * 0.03, hy - h * 0.02);
    pg.endShape(CLOSE);

    pg.beginShape();
    pg.vertex(hx + w * 0.04, hy - h * 0.04);
    pg.bezierVertex(hx + w * 0.02, hy - h * 0.1, hx - w * 0.02, hy - h * 0.15, hx - w * 0.04, hy - h * 0.2);
    pg.vertex(hx - w * 0.02, hy - h * 0.2);
    pg.bezierVertex(hx, hy - h * 0.14, hx + w * 0.03, hy - h * 0.08, hx + w * 0.05, hy - h * 0.02);
    pg.endShape(CLOSE);
    ...
    pg.bezierVertex(cx - w * 0.12, cy - h * 0.08, cx - w * 0.1, cy - h * 0.15, cx - w * 0.05, cy - h * 0.2);
    pg.bezierVertex(cx, cy - h * 0.22, cx + w * 0.05, cy - h * 0.2, cx + w * 0.1, cy - h * 0.15);
    pg.bezierVertex(cx + w * 0.12, cy - h * 0.1, cx + w * 0.12, cy - h * 0.05, cx + w * 0.1, cy);
    ...
    pg.bezierVertex(cx - w * 0.16, cy - h * 0.05, cx - w * 0.18, cy + h * 0.02, cx - w * 0.15, cy + h * 0.08);
    pg.vertex(cx - w * 0.13, cy + h * 0.08);
    pg.bezierVertex(cx - w * 0.15, cy + h * 0.02, cx - w * 0.14, cy - h * 0.04, cx - w * 0.1, cy - h * 0.08);
    pg.endShape(CLOSE);
    // Right arm
    pg.beginShape();
    pg.vertex(cx + w * 0.08, cy - h * 0.08);
    pg.bezierVertex(cx + w * 0.1, cy - h * 0.02, cx + w * 0.08, cy + h * 0.05, cx + w * 0.06, cy + h * 0.1);
    pg.vertex(cx + w * 0.04, cy + h * 0.09);
    pg.bezierVertex(cx + w * 0.06, cy + h * 0.04, cx + w * 0.08, cy - h * 0.01, cx + w * 0.06, cy - h * 0.06);
    pg.endShape(CLOSE);
    ...
    for (var bw = 0; bw < 6; bw++) {
      ...
      pg.line(cx - w * 0.14 + bw * w * 0.005, bwy, cx + w * 0.14 - bw * w * 0.005, bwy + h * 0.002);
    }
    ...
    pg.noFill();
    pg.bezier(cx - w * 0.13, cy - h * 0.14, cx - w * 0.05, cy - h * 0.05, cx + w * 0.05, cy - h * 0.02, cx + w * 0.12, cy - h * 0.12);
    ...
    pg.beginShape();
    pg.vertex(cx - w * 0.1, cy + h * 0.05);
    pg.bezierVertex(cx - w * 0.12, cy, cx - w * 0.12, cy - h * 0.1, cx - w * 0.05, cy - h * 0.2);
    pg.bezierVertex(cx, cy - h * 0.22, cx + w * 0.05, cy - h * 0.2, cx + w * 0.1, cy - h * 0.15);
    pg.bezierVertex(cx + w * 0.12, cy - h * 0.1, cx + w * 0.12, cy, cx + w * 0.1, cy + h * 0.05);
    pg.endShape();
  },
});
