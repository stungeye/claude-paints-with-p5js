...
paintings.push({
  ...
  draw: function (pg) {
    ...
    pg.bezierVertex(w * 0.48, h * 0.615, w * 0.38, h * 0.635, w * 0.32, h * 0.68);
    pg.endShape(CLOSE);
    ...
    pg.ellipse(faceX - faceW * 0.15, faceY + faceH * 0.1, faceW * 0.35, faceH * 0.25);

    // Forehead highlight
    pg.fill(235, 205, 175, 80);
    pg.ellipse(faceX + faceW * 0.05, faceY - faceH * 0.15, faceW * 0.5, faceH * 0.3);

    // Shadow side (left side of face as we see it)
    pg.fill(195, 165, 135, 60);
    pg.ellipse(faceX + faceW * 0.2, faceY + faceH * 0.05, faceW * 0.3, faceH * 0.5);

    // Chin
    pg.fill(222, 192, 162, 80);
    pg.ellipse(faceX - faceW * 0.05, faceY + faceH * 0.4, faceW * 0.35, faceH * 0.2);
    ...
    pg.ellipse(leftEyeX + faceW * 0.01, eyeY - faceH * 0.008, faceW * 0.015, faceH * 0.01);
    pg.ellipse(rightEyeX + faceW * 0.01, eyeY - faceH * 0.008, faceW * 0.012, faceH * 0.008);
    ...
    pg.arc(rightEyeX, eyeY, faceW * 0.11, faceH * 0.055, PI + 0.2, TWO_PI - 0.2);
    ...
    pg.strokeWeight(w * 0.003);
    pg.noFill();
    pg.arc(leftEyeX, eyeY - faceH * 0.06, faceW * 0.15, faceH * 0.04, PI + 0.4, TWO_PI - 0.4);
    pg.arc(rightEyeX, eyeY - faceH * 0.06, faceW * 0.13, faceH * 0.04, PI + 0.4, TWO_PI - 0.4);

    // === NOSE ===
    pg.noStroke();
    pg.fill(210, 178, 148, 60);
    pg.ellipse(faceX - faceW * 0.02, faceY + faceH * 0.08, faceW * 0.08, faceH * 0.12);

    pg.stroke(190, 162, 135, 100);
    pg.strokeWeight(w * 0.002);
    pg.noFill();
    pg.arc(faceX - faceW * 0.04, faceY + faceH * 0.12, faceW * 0.06, faceH * 0.04, -0.3, PI * 0.8);

    // Nose highlight
    pg.noStroke();
    pg.fill(235, 210, 180, 60);
    pg.ellipse(faceX - faceW * 0.02, faceY + faceH * 0.04, faceW * 0.04, faceH * 0.06);
    ...
    pg.bezierVertex(faceX - faceW * 0.05, mouthY - faceH * 0.02, faceX, mouthY - faceH * 0.025, faceX + faceW * 0.02, mouthY);
    pg.bezierVertex(faceX - faceW * 0.02, mouthY + faceH * 0.005, faceX - faceW * 0.06, mouthY + faceH * 0.005, faceX - faceW * 0.1, mouthY);
    pg.endShape(CLOSE);
    ...
    pg.bezierVertex(faceX - faceW * 0.04, mouthY + faceH * 0.04, faceX, mouthY + faceH * 0.04, faceX + faceW * 0.02, mouthY + faceH * 0.005);
    pg.bezierVertex(faceX - faceW * 0.02, mouthY + faceH * 0.005, faceX - faceW * 0.06, mouthY + faceH * 0.003, faceX - faceW * 0.09, mouthY + faceH * 0.005);
    pg.endShape(CLOSE);

    // Lip highlight
    pg.fill(230, 180, 165, 100);
    pg.ellipse(faceX - faceW * 0.04, mouthY + faceH * 0.02, faceW * 0.06, faceH * 0.015);

    // Mouth parting line
    pg.stroke(150, 90, 80, 100);
    pg.strokeWeight(w * 0.002);
    pg.line(faceX - faceW * 0.09, mouthY + faceH * 0.003, faceX + faceW * 0.02, mouthY + faceH * 0.003);
    ...
    pg.bezierVertex(faceX - faceW * 0.1, faceY - faceH * 0.55, faceX - faceW * 0.5, faceY - faceH * 0.45, faceX - faceW * 0.55, faceY - faceH * 0.2);
    pg.bezierVertex(faceX - faceW * 0.58, faceY, faceX - faceW * 0.55, faceY + faceH * 0.15, faceX - faceW * 0.4, faceY + faceH * 0.25);
    pg.bezierVertex(faceX - faceW * 0.3, faceY + faceH * 0.3, faceX - faceW * 0.1, faceY + faceH * 0.3, faceX + faceW * 0.1, faceY + faceH * 0.2);
    pg.bezierVertex(faceX + faceW * 0.25, faceY + faceH * 0.12, faceX + faceW * 0.35, faceY, faceX + faceW * 0.35, faceY - faceH * 0.15);
    pg.bezierVertex(faceX + faceW * 0.35, faceY - faceH * 0.3, faceX + faceW * 0.25, faceY - faceH * 0.4, faceX + faceW * 0.1, faceY - faceH * 0.35);
    pg.endShape(CLOSE);

    // Turban highlight (ultramarine blue)
    pg.fill(60, 100, 165, 150);
    pg.ellipse(faceX - faceW * 0.15, faceY - faceH * 0.35, faceW * 0.5, faceH * 0.25);

    // Turban shadow
    pg.fill(30, 55, 100, 100);
    pg.ellipse(faceX + faceW * 0.15, faceY - faceH * 0.1, faceW * 0.3, faceH * 0.25);

    // Gold/yellow cloth draped down
    pg.fill(190, 165, 70);
    pg.beginShape();
    pg.vertex(faceX + faceW * 0.2, faceY - faceH * 0.15);
    pg.bezierVertex(faceX + faceW * 0.35, faceY - faceH * 0.08, faceX + faceW * 0.3, faceY + faceH * 0.15, faceX + faceW * 0.15, faceY + faceH * 0.3);
    pg.bezierVertex(faceX + faceW * 0.1, faceY + faceH * 0.4, faceX, faceY + faceH * 0.5, faceX - faceW * 0.05, faceY + faceH * 0.55);
    pg.vertex(faceX + faceW * 0.02, faceY + faceH * 0.55);
    pg.bezierVertex(faceX + w * 0.03, faceY + faceH * 0.45, faceX + faceW * 0.15, faceY + faceH * 0.35, faceX + faceW * 0.22, faceY + faceH * 0.2);
    pg.bezierVertex(faceX + faceW * 0.3, faceY + faceH * 0.08, faceX + faceW * 0.28, faceY - faceH * 0.05, faceX + faceW * 0.2, faceY - faceH * 0.15);
    pg.endShape(CLOSE);

    // Gold cloth highlight
    pg.fill(210, 190, 90, 100);
    pg.ellipse(faceX + faceW * 0.22, faceY + faceH * 0.05, faceW * 0.12, faceH * 0.2);
    ...
    pg.noFill();
    pg.bezier(
      faceX - faceW * 0.3, faceY - faceH * 0.1,
      faceX - faceW * 0.1, faceY - faceH * 0.25,
      faceX + faceW * 0.1, faceY - faceH * 0.3,
      faceX + faceW * 0.2, faceY - faceH * 0.2
    );
    pg.bezier(
      faceX - faceW * 0.35, faceY + faceH * 0.05,
      faceX - faceW * 0.2, faceY - faceH * 0.15,
      faceX + faceW * 0.05, faceY - faceH * 0.2,
      faceX + faceW * 0.25, faceY - faceH * 0.1
    );
    ...
    pg.ellipse(pearlX + w * 0.003, pearlY + h * 0.005, pearlSize * 1.2, pearlSize * 1.3);
    ...
    pg.ellipse(pearlX - pearlSize * 0.1, pearlY - pearlSize * 0.1, pearlSize * 0.7, pearlSize * 0.8);

    // Pearl bright highlight
    pg.fill(255, 255, 250, 220);
    pg.ellipse(pearlX - pearlSize * 0.15, pearlY - pearlSize * 0.2, pearlSize * 0.3, pearlSize * 0.35);

    // Pearl secondary highlight (bottom)
    pg.fill(240, 240, 235, 100);
    pg.ellipse(pearlX + pearlSize * 0.05, pearlY + pearlSize * 0.25, pearlSize * 0.25, pearlSize * 0.2);

    // Ear visible
    pg.fill(218, 188, 158);
    pg.ellipse(faceX - faceW * 0.3, faceY + faceH * 0.15, faceW * 0.06, faceH * 0.08);

    // Earring wire
    pg.stroke(200, 190, 160, 120);
    pg.strokeWeight(w * 0.002);
    pg.line(faceX - faceW * 0.28, faceY + faceH * 0.2, pearlX, pearlY - pearlSize * 0.5);
